...
import PDFSplitterView from '@/views/pdf-tools/PDFSplitterView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/pdf-tools/splitter',
  categoryPath: '/pdf-tools',
  namespace: 'pdf-tools.PDFSplitterTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <PDFSplitterView lang={lang as Language} />
    </>
  );
}
