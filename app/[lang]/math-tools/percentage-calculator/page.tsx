...
import PercentageCalculatorView from '@/views/math-tools/PercentageCalculatorView';
...
const SEO_CONFIG: ToolPageSeoConfig = {
  ...
  namespace: 'math-tools.PercentageCalculatorTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <PercentageCalculatorView lang={lang as Language} />
    </>
  );
}
