...
import DateDifferenceView from '@/views/math-tools/DateDifferenceView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/math-tools/date-difference',
  categoryPath: '/math-tools',
  namespace: 'math-tools.DateDifferenceTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <DateDifferenceView lang={lang as Language} />
    </>
  );
}
