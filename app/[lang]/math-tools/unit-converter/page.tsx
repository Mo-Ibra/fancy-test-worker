...
import UnitConverterView from '@/views/math-tools/UnitConverterView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/math-tools/unit-converter',
  categoryPath: '/math-tools',
  namespace: 'math-tools.UnitConverterTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <UnitConverterView lang={lang as Language} />
    </>
  );
}
