...
import NumberBaseConverterView from '@/views/math-tools/NumberBaseConverterView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/math-tools/number-base-converter',
  categoryPath: '/math-tools',
  namespace: 'math-tools.NumberBaseConverterTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <NumberBaseConverterView lang={lang as Language} />
    </>
  );
}
