...
import AgeCalculatorView from '@/views/math-tools/AgeCalculatorView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/math-tools/age-calculator',
  categoryPath: '/math-tools',
  namespace: 'math-tools.AgeCalculatorTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <AgeCalculatorView lang={lang as Language} />
    </>
  );
}
