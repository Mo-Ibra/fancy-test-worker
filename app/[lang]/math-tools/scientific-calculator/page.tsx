...
import ScientificCalculatorView from '@/views/math-tools/ScientificCalculatorView';
...
const SEO_CONFIG: ToolPageSeoConfig = {
  ...
  namespace: 'math-tools.ScientificCalculatorTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <ScientificCalculatorView lang={lang as Language} />
    </>
  );
}
