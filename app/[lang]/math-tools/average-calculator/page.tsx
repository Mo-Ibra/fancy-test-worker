...
import AverageCalculatorView from '@/views/math-tools/AverageCalculatorView';
import ToolJsonLd from '@/components/seo/ToolJsonLd';
import { Metadata } from 'next';
import { Language } from '@/lib/i18n';

const SEO_CONFIG: ToolPageSeoConfig = {
  path: '/math-tools/average-calculator',
  categoryPath: '/math-tools',
  namespace: 'math-tools.AverageCalculatorTool',
};
...
export default async function ToolPage({ params }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <AverageCalculatorView lang={lang as Language} />
    </>
  );
}
