...
import ColorPickerView from '@/views/image-tools/ColorPickerView';
...
const SEO_CONFIG: ToolPageSeoConfig = {
  ...
  namespace: 'image-tools/ColorPickerTool',
};

interface ColorPickerToolPageProps {
  params: Promise<{ lang: string }>;
}

export async function generateMetadata({
  params,
}: ColorPickerToolPageProps): Promise<Metadata> {
...
export default async function ColorPickerToolPage({
  ...
  return (
    <>
      ...
      <ColorPickerView lang={lang as Language} />
    </>
  );
}
