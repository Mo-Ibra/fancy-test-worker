...
export default function Error({
  ...
  return (
    <div className="relative min-h-screen bg-background flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full bg-red-500/10 dark:bg-red-500/5 blur-[120px] pointer-events-none" />

      <div className="relative z-10 text-center px-6">
        <h1 className="text-8xl sm:text-9xl font-bold text-red-500/15 dark:text-red-500/10 leading-none select-none mb-6">
          Error
        </h1>
